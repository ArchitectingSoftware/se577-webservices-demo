...
import { CrossValue, CrossValueType, SourceValue, IsOutsideOfSourceScope, IsOutsideOfExcludedScope, Propagate, IsOmittable, ExclusionValue } from "./utils";
...
declare type DoesTupleSizesMatch<S extends TupleType, E extends TupleType, C extends CrossValueType[]> = And<IsTupleOpen<S>, Not<IsTupleOpen<E>>> extends true ? false : And<IsExcludedSmallEnough<C>, IsExcludedBigEnough<C>>;
declare type IsExcludedSmallEnough<C extends CrossValueType[]> = {
    stop: true;
...
declare type IsExcludedBigEnough<C extends CrossValueType[]> = {
    stop: true;
